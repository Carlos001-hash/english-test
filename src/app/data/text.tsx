...
export const bubble: Bubble[] = [
    {
        id: 1,
        one: ["possui", "uma", "economia", "diversificada", "com", "destaque",  "exportação", "de", "e", "minerais",   "produção",    "de", "laranja", "e", "outros", "lidera", "o",  "setor",  "enquanto", "petróleo", "e",   "potássio",   "são",  "os", "principais", "mineral", "produtos",  "o",  "estado", "exporta", "artesanato",  "produtos", "alimentícios",
              "é", "uma", "empresa", "de", "aeronáutica", "reconhecida", "globalmente", "por", "sua", "fabricação",   "inovadora",    "de", "aviões",   "em",  "a",  "empresa",  "localizada", "em", "A",   "é", "especializada", "em", "aviação", "comercial",   "militar",  "e",   "executiva", "liderando", "avanços",    "setor",   "aeroespacial",
               "A", "arte", "da", "conversação", "é", "uma", "habilidade", "valiosa", "permitindo", "conexões", "significativas", "e", "trocas", "de", "ideias", "Saber", "ouvir", "tão", "importante", "quanto", "falar", "pois", "demonstra", "respeito", "empatia", "pelo", "outro", "Conversas", "são", "pontes", "que", "aproximam", "pessoas", "culturas",
            ],
        two: ["has",     "a",  "economy",  "diversified",    "with", "highlight", "export",   "of",  "and", "mineral", "production", "of",  "orange",  "and", "other", "leads", "the", "sector", "while",     "oil",   "and",   "potassium", "are", "the",   "main",     "mineral",   "products", "the", "state", "exports", "handicraft", "products",   "food",      
               "is", "a",  "company", "of", "aerospace",   "recognized",    "globally",   "for", "its", "manufacturing", "innovative", "of", "aircraft", "in", "the", "company", "located",    "in", "The", "is", "specialized",  "in", "aviation", "commercial", "military", "and", "executive", "leading", "advancements", "sector", "aerospace", 
                "The", "art", "of", "conversation", "is", "a", "skill", "valuable", "allowing", "connections", "meaningful", "and", "exchanges", "of", "ideas", "To know", "to listen", "so", "important", "as", "to speak", "because", "demonstrates", "respect", "empathy", "for", "other", "Conversations", "are", "bridges", "that", "bring closer", "people", "cultures"
            ],
    },{
        id: 2,
        one: ["possui", "uma", "economia", "diversificada", "com", "destaque",  "exportação", "de", "e", "minerais",   "produção",    "de", "laranja", "e", "outros", "lidera", "o",  "setor",  "enquanto", "petróleo", "e",   "potássio",   "são",  "os", "principais", "minerais", "produtos",  "o",  "estado", "exporta", "artesanato",  "produtos", "alimentícios",  "é", "uma", "empresa", "de", "aeronáutica", "reconhecida", "globalmente", "por", "sua", "fabricação",   "inovadora", "de", "aviões",    "em",  "a",  "empresa",  "localizada", "em",  "A",   "é", "especializada", "em", "aviação", "comercial",   "militar",  "e",   "executiva", "liderando", "avanços",    "setor",   "aeroespacial"],
        two: ["has",     "a",  "economy",  "diversified",    "with", "highlight", "export",   "of",  "and", "mineral", "production",  "of", "orange", "and", "other", "leads", "the", "sector", "while",     "oil",     "and",   "potassium", "are", "the",   "main",     "mineral",   "products", "the", "state", "exports", "handicraft", "products",   "food",        "is", "a",  "company","of", "aerospace",   "recognized",    "globally",   "for", "its", "manufacturing", "innovative", "of", "aircraft",  "in", "the", "company", "located",  "in", "The", "is", "specialized",  "in", "aviation", "commercial", "military", "and", "executive", "leading", "advancements", "sector", "aerospace", ],
    },
]
